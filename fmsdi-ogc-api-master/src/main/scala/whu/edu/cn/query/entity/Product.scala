...
/**
 * This class wraps all attributes in product dimension table.
 *
 */
case class Product (_productID: String = "", _productName: String = "", _platform: String = "",
  ...
  var upperLeftLat: String = ""; var upperLeftLong: String = ""
  var upperRightLat: String = ""; var upperRightLong: String = ""
  var lowerLeftLat: String = ""; var lowerLeftLong: String = ""
  var lowerRightLat: String = ""; var lowerRightLong: String = ""
  ...
  def getMeasurementsArray: Array[Measurement] = measurements.toArray
  ...
  def setUpperLeftLat(upperLeftLat: String): Unit = this.upperLeftLat = upperLeftLat;
  def setUpperLeftLong(upperLeftLong: String): Unit = this.upperLeftLong = upperLeftLong;
  def setUpperRightLat(upperRightLat: String): Unit = this.upperRightLat = upperRightLat;
  def setUpperRightLong(upperRightLong: String): Unit = this.upperRightLong = upperRightLong;
  def setLowerLeftLat(lowerLeftLat: String): Unit = this.lowerLeftLat = lowerLeftLat;
  def setLowerLeftLong(lowerLeftLong: String): Unit = this.lowerLeftLong = lowerLeftLong;
  def setLowerRightLat(lowerRightLat: String): Unit = this.lowerRightLat = lowerRightLat;
  def setLowerRightLong(lowerRightLong: String): Unit = this.lowerRightLong = lowerRightLong;
  def getUpperLeftLat: String = upperLeftLat;
  def getUpperLeftLong: String = upperLeftLong;
  def getUpperRightLat: String = upperRightLat;
  def getUpperRightLong: String = upperRightLong;
  def getLowerLeftLat: String = lowerLeftLat;
  def getLowerLeftLong: String = lowerLeftLong;
  def getLowerRightLat: String = lowerRightLat;
  def getLowerRightLong: String = lowerRightLong;
}
...
object Product{
  ...
  def getArdProducts(connAddr: String, user: String, password: String):Array[Product]={
    val allProducts: ArrayBuffer[Product] = getAllProducts(connAddr, user, password)
    val ardProducts: ArrayBuffer[Product] = allProducts.filter(_.productName.contains("ARD"))
    ardProducts.toArray
  }
