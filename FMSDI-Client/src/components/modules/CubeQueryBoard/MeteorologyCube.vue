<template>
  <div>
    <a-drawer :title="$t('meteorologyCube')" :width="600" :visible="visible" :bodyStyle="{ paddingBottom: '80px' }"
      ...
      <a-form-model ref="ruleForm" :model="form" :rules="rules" :label-col="labelCol" :wrapper-col="wrapperCol">
        ...
        <a-form-model-item ref="extentLevel" :label="$t('extentLevel')" prop="extentLevel" has-feedback>
          <a-select v-model="form.extentLevel" :placeholder="$t('pleaseSelectExtentLevel')" :allowClear="true"
            ...
            <a-select-option v-for="variable in Array(0, 1, 2, 3, 4)" :key="variable">
              {{ variable }}
            </a-select-option>
          </a-select>
        </a-form-model-item>
  ...
  data() {
    return {
      ...
      form: {
        ...
        endTime: moment("2020-01-01 01:00:00"),
        variable: [],
      },
      visible: false,
      productList: [],
